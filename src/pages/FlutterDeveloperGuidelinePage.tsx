    ...
    return ItemWidget(key: ValueKey(item.id), item: item);
          ...
          <section id="conclusion" className="p-12 rounded-[2.5rem] bg-primary text-primary-foreground border-none relative overflow-hidden">
            <div className="relative z-10 space-y-6">
              ...
              <p className="opacity-80 max-w-2xl">Following these Flutter standards ensures your mobile applications are performant, maintainable, and deliver a premium user experience.</p>
